            ...
            return (
                <div className='container Posts'>
                    <div className='jumbotron header'>
                        <h1 className="h1-responsive">FTDB</h1>
                        <p className='lead'>Explore posts by other Players.</p>
                        <hr className='my-2' />
                        <div className="flex-row">
                            <Link to='/submitLink' className="card-link">Create a link</Link>
                            <Link to='/submitText' className="card-link">Create a topic</Link>
                        </div>
                    </div>
                    <hr/>
